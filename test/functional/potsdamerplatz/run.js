...
module.exports.functional.address_counts = function(test) {
  test('address db table counts', function(t) {
    ...
    t.equal(addresses, 506, 'count(address)');
...
module.exports.functional.spotcheck_bahnhof_segment = function(test) {
  test('spot checks - bahnhof (train station) segment', function(t) {
    ...
    const count1 = sqlite3.count( paths.db.address, 'address', 'WHERE id=40' );
    t.equal(count1, 2);

    // counts for a specific street (open addresses)
    const count2 = sqlite3.count( paths.db.address, 'address', 'WHERE id=40 AND source="OA"' );
    t.equal(count2, 2);

    // counts for a specific street (vertexes)
    const count3 = sqlite3.count( paths.db.address, 'address', 'WHERE id=40 AND source="VERTEX"' );
    t.equal(count3, 0);
...
module.exports.functional.spotcheck_north_segment = function(test) {
  test('spot checks - north segment', function(t) {
    ...
    // counts for a specific street
    const count1 = sqlite3.count( paths.db.address, 'address', 'WHERE id=45' );
    t.equal(count1, 3);

    // counts for a specific street (open addresses)
    const count2 = sqlite3.count( paths.db.address, 'address', 'WHERE id=45 AND source="OA"' );
    t.equal(count2, 3);

    // counts for a specific street (vertexes)
    const count3 = sqlite3.count( paths.db.address, 'address', 'WHERE id=45 AND source="VERTEX"' );
    t.equal(count3, 0);
...
module.exports.functional.spotcheck_south_segment = function(test) {
  test('spot checks - south segment', function(t) {
    ...
    // counts for a specific street
    const count1 = sqlite3.count( paths.db.address, 'address', 'WHERE id=41' );
    t.equal(count1, 1);

    // counts for a specific street (open addresses)
    const count2 = sqlite3.count( paths.db.address, 'address', 'WHERE id=41 AND source="OA"' );
    t.equal(count2, 1);

    // counts for a specific street (vertexes)
    const count3 = sqlite3.count( paths.db.address, 'address', 'WHERE id=41 AND source="VERTEX"' );
    t.equal(count3, 0);
...
module.exports.functional.spotcheck_weird_north_segment = function(test) {
  test('spot checks - weird north segment', function(t) {
    ...
    // counts for a specific street
    const count1 = sqlite3.count( paths.db.address, 'address', 'WHERE id=39' );
    t.equal(count1, 1);

    // counts for a specific street (open addresses)
    const count2 = sqlite3.count( paths.db.address, 'address', 'WHERE id=39 AND source="OA"' );
    t.equal(count2, 1);

    // counts for a specific street (vertexes)
    const count3 = sqlite3.count( paths.db.address, 'address', 'WHERE id=39 AND source="VERTEX"' );
    t.equal(count3, 0);
...
module.exports.functional.spotcheck_weird_south_segment = function(test) {
  test('spot checks - weird south segment', function(t) {
    ...
    // counts for a specific street
    const count1 = sqlite3.count( paths.db.address, 'address', 'WHERE id=46' );
    t.equal(count1, 2);

    // counts for a specific street (open addresses)
    const count2 = sqlite3.count( paths.db.address, 'address', 'WHERE id=46 AND source="OA"' );
    t.equal(count2, 2);

    // counts for a specific street (vertexes)
    const count3 = sqlite3.count( paths.db.address, 'address', 'WHERE id=46 AND source="VERTEX"' );
    t.equal(count3, 0);
...
module.exports.functional.end_to_end = function(test) {
  test('end to end', function(t) {
    ...
    const rows = sqlite3.exec( paths.db.address, 'SELECT * FROM address WHERE id=40 ORDER BY housenumber' );
...
module.exports.functional.search = function(test) {
  ...
  test('search: exact', function(t) {
    ...
    const coord = { lat: 52.509, lon: 13.376 };
    const number = '4';
    const street = 'potsdamer platz';
