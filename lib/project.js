...
/**
  Calculate the distance (in meters) of linestring
**/
function lineDistance( linestring ){
  var dist = turfLineDistance({ type: 'LineString', coordinates: linestring }, 'kilometers');
  return parseFloat((dist * 1000).toFixed(4)); // meters
}
